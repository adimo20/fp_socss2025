fw_config = {
    ...
    "COMPLETION_PROMPT":"You're an text corrector. You are an expert in correcting texts. You will receive a text in the german language that contain abreviated words, write those abriviated words out " \
    "and return the corrected sentence in the schemes you had been given",
